...
Look up "early onset breast cancer" in Google Scholar and pick a paper to skim.
    ...
    2. What is one thing you learned from this paper: a considerable proportion of the familial risk of breast cancer is not because of mutations in BRCA1 and BRCA2 genes
...
Call the sum function on age_mask. Remember that TRUEs are treated as 1, and FALSEs are treated as 0. Knowing this, what will your sum represent?
    1. Sum = 309; = Number of young patients
...
?surv_fit
age_fit <- surv_fit( surv_object_age ~ age_category,
                     data = clinical )
...
Survival probability is high at the start of diagnosis for both young and old people. Survival probability decreases and is significantly lower for older people once 4000 days has past. 
...
write.csv(clinical, "//Users/anikakapai/desktop/qbio_490_anika/week4_clinical_anika/brca_clinical_data.csv", row.names = FALSE)
```
